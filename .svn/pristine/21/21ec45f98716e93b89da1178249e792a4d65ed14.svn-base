...
define(['angular'], function (angular) {
    ...
    var test = angular.module('dict', []);
    test.controller('dictCtrl',function($scope, $log, $mdDialog, $mdMedia,NgTableParams,$http,$cookies,$filter,$mdToast,$location,$timeout){
        ...
        function getapp1(page,size){
            var getconfig = {
                method: 'POST',
                //url: APP_CONFIG.CDP_URL+'/docker/dict/'+urltype,
                url: APP_CONFIG.CDP_URL+'/docker/dict/pageQuery',
                headers: {
                ...
                data:{
                    ...
                    code:$scope.search.code == ''? undefined:$scope.search.code,
        ...
        $scope.add = function(ev) {
            ...
            $mdDialog.show({
                ...
                templateUrl: 'templates/basicdata/dict-dialog1.html',
            ...
            function DialogController1($scope, $mdDialog) {
                ...
                $scope.answer = function(answer) {
                    var getconfig = {
                        ...
                        url: APP_CONFIG.CDP_URL+'/docker/dict/',
                        headers: {
                            'x-auth-token': $cookies.get("JSESSION")
                        },
                        data:{
                            code:$scope.dict.code,
                            name:$scope.dict.name,
                            description:$scope.dict.description
                        }
                    };
                    $http(getconfig)
                        .success(function(data, status, headers, config) {
        ...
        $scope.edit = function(ev,item) {
            ...
            $mdDialog.show({
                ...
                templateUrl: 'templates/basicdata/dict-dialog2.html',
                parent: angular.element(document.body),
                targetEvent: ev,
                clickOutsideToClose:true,
                fullscreen: useFullScreen
            ...
            function DialogController2($scope, $mdDialog) {
                ...
                $scope.delete = function(){
                    var getconfig = {
                        method: 'DELETE',
                        url: APP_CONFIG.CDP_URL+'/docker/dict/'+$scope.dict.id,
                        headers: {
                            'x-auth-token': $cookies.get("JSESSION")
                        }
                    };
        ...
        $scope.detail = function(ev,item) {
            $location.path("/dictdetail").search('dictdetailname',item)
        };
