...
*/angular.module('scDateTime', []).value('scDateTimeConfig', {
  ...
  incrementHours: "加一小时",
  decrementHours: "减一小时",
  incrementMinutes: "加一分钟",
  decrementMinutes: "减一分钟",
  switchAmPm: "切换 上午/下午",
  now: "选择现在",
  cancel: "取消选择",
  save: "确定选择",
