...
define(['angular'], function (angular) {
    ...
    var test = angular.module('editmoneytable', []);
    test.controller('editmoneytableCtrl',function($scope, $log, $mdDialog, $mdMedia,$http,$cookies,$filter,$mdToast,$location,$timeout,$mdEditDialog,busiorgPublic){
        ...
        var watch1 = $scope.$watch('$location.search()',function(newValue,oldValue, scope){
            if($location.search().status != null && $location.search().status != undefined){
                ...
                window.location.href=APP_CONFIG.FRONT_URL+"/index.html#/editbudget_money_list"
            }
        });
                ...
                $http(getconfig)
                    .success(function(data, status, headers, config) {
                        ...
                        if(data.code=='0000'){
                            ...
                            $scope.query.order_type = data.data.emsbmadjustapplyh.order_type;
        ...
        var watch2 = $scope.$watch('appdata',function(newValue,oldValue, scope){
            if($scope.appdata!= null && $scope.appdata != undefined){
                var aa=0;
        ...
        $scope.add = function(ev,id,item) {
            ...
            $mdDialog.show({
                ...
                templateUrl: 'templates/basicdata/budgetadjust/editmoneytable-dialog1.html',
            ...
            var getconfig = {
                ...
                data: {
                    emsbmadjustapplyh:{
                        ...
                        order_type:$scope.query.order_type,
                        ...
                        $http(getconfig)
                            .success(function(data, status, headers, config) {
                                ...
                                if(data.code=='0000'){
                                    ...
                                    $location.path("/editbudget_money_process")
        ...
        $scope.back = function (){
            $location.path("/editbudget_money_list")
        };
    ...
    angular._LoadModule('editmoneytable');
    return test;
});