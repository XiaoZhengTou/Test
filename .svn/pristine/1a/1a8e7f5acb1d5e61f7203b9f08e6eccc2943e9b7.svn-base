...
define(['angular'], function (angular) {
    ...
    var test = angular.module('pedefine', []);
    test.controller('pedefineCtrl',function($scope, $log, $mdDialog, $mdMedia,NgTableParams,$http,$cookies,$filter,$mdToast,$location,$timeout){
        ...
        $scope.add = function(ev) {
            ...
            $mdDialog.show({
                ...
                templateUrl: 'templates/basicdata/menu/pedefine-dialog1.html',
        ...
        $scope.edit = function(ev,item) {
            ...
            $mdDialog.show({
                ...
                templateUrl: 'templates/basicdata/menu/pedefine-dialog2.html',
                parent: angular.element(document.body),
                targetEvent: ev,
                clickOutsideToClose:true,
                fullscreen: useFullScreen
            ...
            function DialogController2($scope, $mdDialog) {
                ...
                $scope.answer = function(answer) {
                    var getconfig = {
                        ...
                        data:{
                            "description": $scope.pedefine.description,
                            "name": $scope.pedefine.name,
                            "id":$scope.pedefine.id
                        }
                    };
                    $http(getconfig)
                        .success(function(data, status, headers, config) {
