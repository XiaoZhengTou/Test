define(['angular'], function(angular) {
	...
	var airfareDetail = angular.module('airfareDetail', []);
	airfareDetail.controller('airfareDetailCtrl', function($scope, $rootScope, airfarePublic, statusPublic, publicmodel, $mdDialog) {
		$scope.airfareList = airfarePublic.airfareList;
		console.log($scope.airfareList);
		
		$scope.gotuipiao = function(){
			$scope.go('/telAirfare/tuipiao',"退票详情");
		}
		$scope.gogaiqian = function(){
			$scope.go('/telAirfare/gaiqian',"改签详情");
		}
