...
define(['angular','js/shared/process.js'], function (angular) {
    var test = angular.module('editmoneyprocess', ['mdproceslist']);
    test.controller('editmoneyprocessCtrl',function($scope, $log, $mdDialog, $mdMedia,$http,$cookies,$filter,$mdToast,$location,$timeout,$mdEditDialog,busiorgPublic){
    ...
    angular._LoadModule('editmoneyprocess');
    return test;
});