...
define(['angular'], function (angular) {
    ...
    var test = angular.module('provider', []);
    test.controller('providerCtrl',function($scope, $log, $mdDialog, $mdMedia,NgTableParams,$http,$cookies,$filter,$mdToast,$timeout){
        ...
        //搜索
        $scope.search_provider = function(){
        ...
        function getapp1(page,size){
            var getconfig = {
                method: 'POST',
                url: APP_CONFIG.JIEBAO_URL+'/docker/vendor/queryAllPage',
                headers: {
                ...
                data:{
                    ...
                    vendor_name:$scope.search.vendor_name == ''? undefined:$scope.search.vendor_name,
                    vendor_status:$scope.search.vendor_status == 'ALL'? undefined:$scope.search.vendor_status,
                    vendor_code:$scope.search.vendor_code == ''? undefined:$scope.search.vendor_code
                }
            };
            $http(getconfig)
