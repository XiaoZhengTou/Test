...
define(['angular'], function(angular) {
	var app = angular.module('mdbudget', []);
	//预算部门
	app.directive('drBudget', ['$mdMedia', '$mdDialog', '$http', '$parse', '$filter', function($mdMedia, $mdDialog, $http, $parse, $filter) {
		return {
			restrict: 'E',
			replace: true,
			//priority: 100,
			template: '<div layout-gt-sm="row"><md-input-container class="md-block" flex-gt-sm><label>{{titlenamea}}</label><md-select ng-change="changeOrg()" placeholder="{{titlenamea}}" ng-model="remodel.org" style="text-align: left;margin: 0px;" >' +
